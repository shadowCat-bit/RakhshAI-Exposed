        ...
        s.hasAttribute("data-layout") && "horizontal" == s.getAttribute("data-layout")
            ? (m("layout-horizontal"),
              ...
              "light" == s.hasAttribute("data-topbar")
                  ? (m("topbar-color-light"), document.body.setAttribute("data-topbar", "light"))
                  : "dark" == s.hasAttribute("data-topbar") && (m("topbar-color-dark"), document.body.setAttribute("data-topbar", "dark")),
        ...
        (a = document.getElementsByTagName("body")[0]).hasAttribute("data-layout") && "horizontal" == a.getAttribute("data-layout")
            ? (m("layout-horizontal"),
              "light" == a.hasAttribute("data-topbar")
                  ? (m("topbar-color-light"), document.body.setAttribute("data-topbar", "light"))
                  : "dark" == a.hasAttribute("data-topbar") && (m("topbar-color-dark"), document.body.setAttribute("data-topbar", "dark")),
              (document.getElementById("sidebar-setting").style.display = "none"),
              document.body.removeAttribute("data-sidebar"))
            : (m("layout-vertical"), (document.getElementById("sidebar-setting").style.display = "block")),

@extends('admin.layouts.public', ['title' => 'چت ها' . ' ' . $userAi->ai_title])
@section('content')
                                    ...
                                    <div class="card-body">
                                       ...
                                       <div class="text-center bg-light rounded px-4 py-3">
                                                ...
                                                <div class="chat-user-status">
                                                    <img width="70" src={{$userAi->ai_avatar}} class="avatar-md rounded-circle" alt="">
                                                    <div class="">
                                                    ...
                                                    <div class="pt-3">
                                                        ...
                                                        <ul class="list-unstyled chat-list">
                                                            @foreach ($convs as $conv)
                                                                <li>
                                                                    <a href="{{route('admin.users-ai.show', ['ai_id' => $userAi->id , 'conv_id' => $conv->id, 'user_id' => $user->id])}}">
